  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'wave-pattern': 'radial-gradient(circle at 20% 50%, hsl(175 75% 50% / 0.3) 0%, transparent 60%), radial-gradient(circle at 80% 20%, hsl(165 80% 55% / 0.25) 0%, transparent 60%), radial-gradient(circle at 40% 80%, hsl(185 85% 50% / 0.2) 0%, transparent 60%)',
        'organic-shapes': 'radial-gradient(ellipse at 30% 30%, hsl(175 75% 50% / 0.12) 0%, transparent 50%), radial-gradient(ellipse at 70% 70%, hsl(165 80% 55% / 0.1) 0%, transparent 50%), radial-gradient(circle at 50% 50%, hsl(210 100% 25% / 0.08) 0%, transparent 55%)',
      },
      boxShadow: {
        'eco': 'var(--shadow-eco)',
