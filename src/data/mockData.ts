...
export const MOCK_PROGRAMS: MockProgram[] = [
  // Expert 1's programs - IN-PERSON workshops
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1517686469429-8bdb88b9f907?w=800&h=600&fit=crop',
    thumbnail_url: 'https://images.unsplash.com/photo-1517686469429-8bdb88b9f907?w=400&h=300&fit=crop',
    price_huf: 15000,
    ...
    is_published: true,
    is_featured: true,
    sponsor_name: 'Praktiker',
    sponsor_name_en: 'Praktiker',
    sponsor_name_de: 'Praktiker',
    sponsor_logo_url: 'https://logo.clearbit.com/praktiker.hu',
    is_sponsored: true,
    fixed_sponsor_amount: 12000,
  ...
  // Expert 2's programs - ONLINE LIVE sessions
  {
    ...
    is_published: true,
    is_featured: true,
    sponsor_name: 'Rossmann',
    sponsor_name_en: 'Rossmann',
    sponsor_name_de: 'Rossmann',
    sponsor_logo_url: 'https://logo.clearbit.com/rossmann.de',
    is_sponsored: true,
    fixed_sponsor_amount: 6400,
