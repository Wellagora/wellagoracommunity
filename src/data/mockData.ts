...
export const MOCK_EXPERTS: MockExpert[] = [
  {
    ...
    bio_de: 'Seit über 20 Jahren baue ich Öfen in unserer Region.',
  ...
  },
  {
    ...
    expert_bio_long: 'A régió vulkanikus talaja egyedi borokat ad. Megtanítom a résztvevőket a helyi szőlőfajták megismerésére és a hagyományos borkészítés titkaira.',
...
export const MOCK_PROGRAMS: MockProgram[] = [
  // Expert 1's programs (Kovács István - Kemencemester)
  {
    ...
    title_de: 'Meistergeheimnisse des Ofenbaus',
    ...
    description_de: 'Entdecke die Meistergeheimnisse des traditionellen Ofenbaus!',
  ...
  },
  {
    ...
    description_de: 'Die Geheimnisse des perfekten Sauerteigbrots im traditionellen Ofen.',
  ...
  // Expert 2's programs (Nagy Éva - Gyógynövényszakértő)
  {
    ...
    description_de: 'Entdecke heimische Heilkräuter mit einer Expertin!',
  ...
  // Expert 3's programs (Szabó Péter - Borkészítő)
  {
    ...
    description: 'Ismerd meg a régió borait!',
    description_en: 'Discover the wines of our region!',
    description_de: 'Entdecke die Weine unserer Region!',
  ...
  },
  {
    ...
    description_de: 'Nimm an der Herbstlese teil!',
  ...
  },
  {
    ...
    description_de: 'Gestalte einzigartige Weihnachtsdekorationen!',
  ...
  },
  {
    ...
    description_de: 'Erlebe den traditionellen Prozess der Honigernte hautnah!',
