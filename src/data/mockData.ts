...
export const MOCK_PROGRAMS: MockProgram[] = [
  ...
  // Expert 2's programs
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1471943311424-646960669fbc?w=800&h=600&fit=crop',
    thumbnail_url: 'https://images.unsplash.com/photo-1471943311424-646960669fbc?w=400&h=300&fit=crop',
    price_huf: 8000,
    access_type: 'sponsored',
    access_level: 'sponsored',
    category: 'wellness',
