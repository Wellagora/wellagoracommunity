        ...
        <div className="text-center mb-8 sm:mb-12">
          <div className="max-w-md mx-auto mb-6 sm:mb-8 relative">
            <img 
              ...
              className="w-32 h-32 sm:w-40 sm:h-40 lg:w-48 lg:h-48 object-cover rounded-2xl shadow-eco mx-auto mb-4 sm:mb-6"
            />
            <div className="absolute -top-2 -right-8 sm:-right-1/4 w-10 h-10 sm:w-12 sm:h-12 bg-success rounded-full flex items-center justify-center animate-pulse">
